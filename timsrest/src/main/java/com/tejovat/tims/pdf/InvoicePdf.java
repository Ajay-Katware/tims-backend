...
public class InvoicePdf{
	...
	public static void main(String[] args) throws Exception {
		...
		new InvoicePdf().manipulatePdf(salesOrder, DEST, IMAGE4);
	}

	public InvoicePdf() throws IOException {
	...
	public void manipulatePdf(SalesOrder salesOrder, String dest, String img) throws FileNotFoundException, MalformedURLException{
		...
		// first row
		Cell cell1 = new Cell(1,3).add(new Paragraph("INVOICE"));
	...
	private IBlockElement createSalesorderTable(SalesOrder salesOrder) {
		...
		cell = new Cell().add("INVOICE").setFont(bold).setFontSize(14);
		cell.setBorder(Border.NO_BORDER);
		cell.setFontSize(11);
		cell.setTextAlignment(TextAlignment.RIGHT);
		innertable.addCell(cell);

		cell = new Cell().add("INVOICE NO# "+salesOrder.getInvoiceno()!=null?salesOrder.getInvoiceno():" ");
		cell.setBorder(Border.NO_BORDER);
		cell.setFontSize(9);
		cell.setTextAlignment(TextAlignment.RIGHT);
		innertable.addCell(cell);
	...
	private Table createItemInfoTable(SalesOrder salesOrder, List<SalesItem> list) {
		...
		cell = new Cell(1,5).add("Terms: A service charge will be chrged to you on any balance outstanding at the end of each at the rate of 1.5% per month calculated and compounded monthly(19.57% per annum)");
		cell.setTextAlignment(TextAlignment.LEFT);
		cell.setFontSize(7);
		cell.setBorder(Border.NO_BORDER);
		innertable.addCell(cell);
		...
		cell = new Cell(1,5).add("All manufacturer's names, number, symbols and descriptions are used for reference purposes only and it is is not implied that any part listed is the product of these manufacturer's. All goods listed above the property of Tejovat Technology until fully paid for.");
		cell.setTextAlignment(TextAlignment.LEFT);
		cell.setFontSize(7);
		cell.setBorder(Border.NO_BORDER);
		innertable.addCell(cell);
		...
		cell = new Cell(1,5).add("Thank you for your continued patronage!");
		cell.setTextAlignment(TextAlignment.LEFT);
		cell.setFontSize(11);
		cell.setFont(bold);
		cell.setBorder(Border.NO_BORDER);
