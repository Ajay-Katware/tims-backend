...
public class CustomerMaster implements Serializable {
	...
	public String toString() {
		return "CustomerMaster [id=" + id + ", salutation=" + salutation + ", firstname=" + firstname + ", lastname="
				+ lastname + ", contactno=" + contactno + ", alternatecontact=" + alternatecontact + ", emailid="
				+ emailid + ", alternateemail=" + alternateemail + ", faxno=" + faxno + ", billstreetno=" + billstreetno
